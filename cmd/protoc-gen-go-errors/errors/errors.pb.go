...
func (x *Error) GetCode() int32 { _ = "STUB: not implemented"; return 0 }

func (x *Error) GetReason() string { _ = "STUB: not implemented"; return "" }

func (x *Error) GetMessage() string { _ = "STUB: not implemented"; return "" }

func (x *Error) GetMetadata() map[string]string { _ = "STUB: not implemented"; return nil }
...
func file_errors_proto_rawDescGZIP() []byte { _ = "STUB: not implemented"; return nil }
...
func file_errors_proto_init() { _ = "STUB: not implemented"; return }
